...
import 'CoverImageScreen.dart';
// CoverImageScreen('/images/group_image.jpeg'),

class ScrollExperiment extends StatefulWidget {
  ScrollExperiment({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _ScrollExperimentState createState() => new _ScrollExperimentState();
}

class _ScrollExperimentState extends State<ScrollExperiment> {
  String imageUrl = "images/group_image.jpeg";
...
class _CardStackState extends State<CardStack>
  ...
  var cards = [
    TouristCard(index: 0, imageUrl: "images/group_image.jpeg"),
    TouristCard(index: 1, imageUrl: "images/group_image.jpeg"),
    TouristCard(index: 2, imageUrl: "images/group_image.jpeg"),
    TouristCard(index: 3, imageUrl: "images/group_image.jpeg"),
    TouristCard(index: 4, imageUrl: "images/group_image.jpeg"),
    TouristCard(index: 5, imageUrl: "images/group_image.jpeg")
  ];
  int currentIndex;
